...
Completed MNIST Neural Net class with customizable learning rate, nueron structure, batch sizes, and epochs. Comes as a complete class with example code in the same notebook. Loss function set to categorical cross entropy. 
